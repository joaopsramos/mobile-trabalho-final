...
import com.example.grocelist.ui.history.HistoryDetailsViewModel
...
import com.example.grocelist.ui.shopping_cart.AddCartViewModel
...
val appModule = module {
    ...
    viewModel { HistoryDetailsViewModel(get(), get()) }
}
